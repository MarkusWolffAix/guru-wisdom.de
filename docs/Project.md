...
The project operates across three distinct environments with a specialized focus on data integrity for media assets:

* **Development (Dev):** Hosted locally on **macOS** (`/Users/markuswolff/guru-wisdom.de`). This is the primary workstation and the "Source of Truth" for all high-resolution master media files.
