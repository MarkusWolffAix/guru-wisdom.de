...
<div class="impressum">
    ...
    <address itemscope itemtype="schema.org/PostalAddress">
        <span itemprop="name"><strong>GURU Wisdom GmbH</strong></span>
        <div class="w-100"></div> 
    ...
    <h3>4. Wichtiger Hinweis zu Inhalten der Lebenshilfe, Gesundheit und Beratung</h3>
    <p>Die auf <strong>Guru-wisdom.de</strong> zur Verfügung gestellten Informationen, Artikel, Tipps und eventuellen Beratungsangebote (insbesondere in den Bereichen Persönlichkeitsentwicklung, Spiritualität, Lebenshilfe und Wohlbefinden) dienen ausschließlich der allgemeinen Information, Inspiration und der persönlichen Weiterentwicklung.</p>
